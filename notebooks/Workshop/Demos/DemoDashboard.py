...
# MAGIC %md Create a graph of bike conditions across each of the seasons. Also create a cell with this label to correctly label the graph.
...
# MAGIC %md Navigate to the **View** menu and select **+ New Dashboard**.
# MAGIC 
...
# MAGIC %md By default the new dashboard includes all cells that you've created thus far. You can rearrange and reshape each cell as you see fit. Navigate back to the notebook code by selecting the **Code** option from the **View** menu.
# MAGIC 
# MAGIC ![something](https://docs.databricks.com/_static/images/dashboards/dashboard-demo-2.png)

# COMMAND ----------

# MAGIC %md New cells do not automatically appear on your dashboard. You add them manually by clicking the dashboard icon at the far right and selecting the checkbox next to the dashboard name.
# MAGIC 
...
# MAGIC %md **Extreme Biking Conditions**
